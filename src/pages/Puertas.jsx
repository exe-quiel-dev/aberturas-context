...
const Puertas = () => {
    return (
        <section className="min-h-screen flex items-center jusrify-center bg-puertas">
            <div className="flex flex-col lg:grid lg:grid-cols-6 items-center justify-items-center p-10 w-full h-screen gap-6 backdrop-blur-sm">
          <Link
            to='/chapasimple'
            className="text-white text-xl bg-white/25 btn p-6 transition-all cursor-pointer hover:shadow-lg text-center uppercase tracking- w-full"
